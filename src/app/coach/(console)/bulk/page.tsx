    ...
    <div className="stagger space-y-6">
      <div>
        ...
        <p className="text-sm text-chalk-mute font-body max-w-2xl">
          Push one template week to many clients at once. Each client gets loads off
          their own e1RM: %1RM when you give one, otherwise the reps×RPE chart. It
          appends as the next week of each client&apos;s program.
        </p>
      </div>
