...
function Step3({ profile, update }: StepProps) {
  return (
    <div>
      <StepHeader num={3} title="Schedule & Goals" subtitle="What does the next 12 weeks look like?" />
      <div className="space-y-5">
        <Select
  ...
  return (
    <div>
      <StepHeader
        num={4}
        title="Nutrition"
        subtitle="Macros are calculated from your stats. Meal plans are generated by your coach."
      />
      <div className="space-y-5">
        <Select
          label="Current phase"
...
function Step5({ profile }: StepProps) {
  ...
  return (
    <div>
      <StepHeader num={5} title="Review" subtitle="Last chance to fix anything. Hit Generate when it looks right." />
